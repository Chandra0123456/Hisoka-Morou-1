...
global.mess = (type, m, options = {}) => {
	let msg = {
		...
		admin: 'Perintah ini hanya dapat digunakan oleh admin group, lu tuh cuma member!!',
...
global.options = {
	...
	owner: ["6282163403132", "6283182628110"],
	pathCommand: 'commands'
}
global.Exif = {
	packId: "https://instagram.com/cw",
	packName: `Sticker ini Dibuat Oleh :\nhttps://instagram.com/cw\n\nPada :\n${Function.tanggal(new Date())} Pukul ${Function.jam(new Date())} WIB\n\nOleh :\nDika Ardnt.`,
	packPublish: "CW",
	packEmail: "chandssi00@gmail.com",
